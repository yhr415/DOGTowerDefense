...
const stageDesign = [
    {
      ...
      bossType: "pome",bossColor : "white",bossHp: 5, bossSpeed: 0.3,
    ...
    { 
      ...
      // 보스
      bossType: "bordercollie",bossColor : "blackandwhite", bossHp: 30, bossSpeed: 0.3,
      // 보상 & 정보
    ...
    { 
      stage: 2, 
      petType: "pome", petCount: 20, interval: 50, petHp: 10, petSpeed: 0.5,
      bossType: "jindo",bossColor : "white", bossHp: 60, bossSpeed: 0.3,
    ...
    { 
      ...
      bossType: "retriever",bossColor:"gold", bossHp: 200, bossSpeed: 0.3, 
      stageReward: 600, fact: "Stage 3: 높은 체력 (슬로우, 집중케어 타워 해금)" 
    },
    
    { 
      stage: 4, 
      petType: "pome", petCount: 15, interval: 100, petHp: 30, petSpeed: 1.0,
      bossType: "blackretriever",bossColor:"black", bossHp: 350, bossSpeed: 0.4,
      stageReward: 1500, fact: "Stage 4: 빠른 속도 대처 (block, 놀이터 해금)" 
    },
    
    { 
      stage: 5, 
      petType: "pome", petCount: 40, interval: 30, petHp: 40, petSpeed: 0.7,
      bossType: "poodle",bossColor:"brown", bossHp: 1000, bossSpeed: 0.4,

...
dogPics['retriever'] ||= {};
dogPics['retriever']['brown'] ||= {};
dogPics['retriever']['brown']['sad'] = loadImage('data/dog/golden_Retriever.png');
dogPics['retriever']['brown']['neutral'] = loadImage('data/dog/golden_Retriever.png');
dogPics['retriever']['brown']['happy'] = loadImage('data/dog/golden_Retriever.png');
